...
export const run = async (contexto) => {
  ...
  if (!targets.length) return reply("⚠️ Menciona a alguien para cargar.");
  ...
  return reply(`¡*${n1}* ha tomado a *${n2}* en sus brazos! 🏋️`);
};
