...
cmdLine("🦶","kick @user",   "Dar una patada."),
cmdLine("🫦","kabedon @user", "Acorralar contra la pared."),
category("🖼️ 𝓜edia"),
cmdLine("🎨","s / sticker",  "Convierte la imagen/video citado en sticker."),
cmdLine("⭕","scirculo",      "Sticker con recorte circular."),
cmdLine("🖼️","sfull",        "Sticker sin recorte (completo)."),
cmdLine("♻️","take / wm",     "Roba un sticker con los créditos del bot."),
].join("");
...
cmdLine("👁️","verexcusa [@user]", "Ver la excusa activa de alguien."),
cmdLine("📋","verexcusas",        "Ver todas las excusas activas del grupo."),
...
cmdLine("🎖️","promover @user N", "Cambiar el rango de un usuario (0-2)."),
